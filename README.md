...
**Solution:** This project solves this data quality issue by designing a Character-Level Convolutional Neural Network (Char-CNN) built with TensorFlow/Keras. By masking obvious keywords during training to prevent data leakage, the model learns the deep latent structure of North African names and corporate acronyms, achieving a 95%+ F1-Score on messy production data.
